    ...
    return (
        <section className="bg-background px-4 sm: py-4">
            <header className="mb-4">
                <h2 className="text-2xl sm:text-3xl font-semibold font-sans">About</h2>
            </header>

            <div className="prose prose-neutral dark:prose-invert max-w-none">
                <p className="text-sm sm:text-base leading-relaxed text-muted-foreground font-mono text-justify">
                    {content}
                </p>
            </div>
        </section>
